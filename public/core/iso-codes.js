/**
 * iso-codes.js — ISO 3166-1 numeric → alpha-3 country code mapping.
 *
 * Used to join world-atlas TopoJSON features (which use numeric IDs)
 * with birth data (which uses alpha-3 codes).
 *
 * Public API:
 *   numericToAlpha3  — Map<string, string> from numeric to alpha-3
 */

export const numericToAlpha3 = new Map([
  ...
  ['524', 'NPL'], ['528', 'NLD'], ['531', 'CUW'], ['533', 'ABW'], ['534', 'SXM'],
  ...
  ['634', 'QAT'], ['638', 'REU'], ['642', 'ROU'], ['643', 'RUS'], ['646', 'RWA'],
  ['652', 'BLM'], ['654', 'SHN'], ['659', 'KNA'], ['660', 'AIA'], ['662', 'LCA'],
  ...
  ['732', 'ESH'], ['740', 'SUR'], ['744', 'SJM'], ['748', 'SWZ'], ['752', 'SWE'],
